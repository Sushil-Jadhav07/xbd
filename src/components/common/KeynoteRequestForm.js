...
export default function KeynoteRequestForm({ open, onClose }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setSuccessMessage("Thanks! Our team will contact you with keynote details.");
      setFormValues({
        name: "",
        email: "",
        phone: "",
  ...
  function submitToMailchimp(values) {
    return new Promise((resolve, reject) => {
      ...
      const params = new URLSearchParams({
        ...
        "b_279a02443a57a9821b4e42c23_c1a5bd146d": "",
      });

      const callbackName = "mcKeynoteCallback_" + Date.now();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Provide host details so we can tailor the keynote for your event.
        </p>
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 w-full text-gray-800 rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900"
