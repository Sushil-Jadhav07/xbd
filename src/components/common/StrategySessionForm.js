...
export default function StrategySessionForm({ open, onClose }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setSuccessMessage("Thanks! We will confirm the strategy call shortly.");
      setFormValues({
        name: "",
        email: "",
        phone: "",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Tell us who to expect and we&apos;ll line up the right advisors.
        </p>
